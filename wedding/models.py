...
class Rsvp(models.Model):
    ...
    manila_flight_into = models.CharField(
        _("Manila arrival flight number (into Manila)"), max_length=20, null=True)
    ...
    manila_staying = models.CharField(
        _("Staying in Manila"), max_length=50, choices=EVENTS_CHOICES, null=True)
    boracay_flight_into = models.CharField(
        _("Boracay arrival flight number (into Boracay)"), max_length=20, null=True)
    ...
    boracay = models.CharField(
        _("Staying in Boracay"), max_length=50, choices=EVENTS_CHOICES, null=True)
    shoe_size = models.PositiveIntegerField(
        _("Your shoe size"), choices=SHOE_SIZE_CHOICES, null=True)
    dietary_restrictions = models.CharField(
        _("Your dietary restrictions"), max_length=50, choices=DIETARY_CHOICES, null=True)
    number_of_guests = models.PositiveIntegerField(_("No. of guests"))
    ...
    guest_dietary_restrictions = models.CharField(
        _("Guest’s dietary restrictions"), max_length=50, choices=DIETARY_CHOICES, null=True)
